...
export const DashboardHeader: React.FC = () => {
  ...
  // Prevent navigation to homepage without logout
  const handleNavigation = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    alert("Please use the logout button to exit the dashboard.");
  };

  // Calculate cart count from items in cart
  const cartItemCount = 3; // This would come from a real cart context in a production app

  return (
    <header className={styles.dashboardHeader}>
      <div className={styles.headerContainer}>
        <div className={styles.logo}>
          <span onClick={handleNavigation}>MBK</span>
        </div>
        ...
        <div className={styles.headerActions}>
          ...
          <div className={styles.profileDropdown} ref={dropdownRef}>
            ...
            >
              ...
              <span className={styles.profileName}>{user?.name || 'John Smith'}</span>
              <svg 
            ...
            {isDropdownOpen && (
              <div className={styles.dropdownMenu}>
                <div className={styles.dropdownHeader}>
                  ...
                  <div>
                    <p className={styles.dropdownName}>{user?.name || 'John Smith'}</p>
                    <p className={styles.dropdownEmail}>{user?.email || 'john@example.com'}</p>
                  </div>
                </div>
